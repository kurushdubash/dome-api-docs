...
|--------|----------|-------------|
| `POST` | `/v1/polymarket/placeOrder` | [Place order with fee escrow](#rest-endpoint) |
| `GET` | `/v1/polymarket/orders/:orderId` | [Get order status](#get-escrow-order) |
| `GET` | `/v1/polymarket/orders` | [List escrow orders](#list-escrow-orders) |
| `DELETE` | `/v1/polymarket/orders/:orderId` | [Cancel order and refund](#cancel-escrow-order) |
| `POST` | `/v1/polymarket/affiliate` | [Set affiliate address](/order-router/user-settings#set-affiliate-address) |
| `GET` | `/v1/polymarket/fees` | [Get fee configuration](/order-router/user-settings) |
| `PUT` | `/v1/polymarket/fees` | [Update fee configuration](/order-router/user-settings) |
