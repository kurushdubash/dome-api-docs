...
| `safeTxPayload` | `object` | SafeTx EIP-712 payload for setting allowances (only for freshly deployed Safes) |
| `allowancesToSet` | `string[]` | List of allowances to set: `CTF_EXCHANGE`, `NEG_RISK_CTF_EXCHANGE`, `NEG_RISK_ADAPTER` |
