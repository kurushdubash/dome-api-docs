...
|-------------|----------|
| Production | `https://order-router.domeapi.io` |
...
```bash cURL
curl -X POST https://order-router.domeapi.io/link/prepare \
...
const response = await fetch('https://order-router.domeapi.io/link/prepare', {
  method: 'POST',
...
response = requests.post(
    'https://order-router.domeapi.io/link/prepare',
    json={
        'jsonrpc': '2.0',
        'method': 'linkPrepare',
        'id': 'req-1',
...
```bash cURL
curl -X POST https://order-router.domeapi.io/link/complete \
  -H "Content-Type: application/json" \
  -d '{
    "jsonrpc": "2.0",
    "method": "linkComplete",
...
```typescript TypeScript
const response = await fetch('https://order-router.domeapi.io/link/complete', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
    jsonrpc: '2.0',
...
response = requests.post(
    'https://order-router.domeapi.io/link/complete',
    json={
        'jsonrpc': '2.0',
        'method': 'linkComplete',
        'id': 'req-2',
...
```bash cURL
curl -X POST https://order-router.domeapi.io/link/setAllowances \
  -H "Content-Type: application/json" \
  -d '{
    "jsonrpc": "2.0",
...
const response = await fetch('https://order-router.domeapi.io/link/setAllowances', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
    jsonrpc: '2.0',
...
response = requests.post(
    'https://order-router.domeapi.io/link/setAllowances',
    json={
        'jsonrpc': '2.0',
        'method': 'setAllowances',
        'id': 'req-3',
...
const prepareResponse = await fetch('https://order-router.domeapi.io/link/prepare', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
    jsonrpc: '2.0',
...
const completeResponse = await fetch('https://order-router.domeapi.io/link/complete', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
    jsonrpc: '2.0',
...
```bash
curl https://order-router.domeapi.io/link/health
```
