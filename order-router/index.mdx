---
title: "Order Router"
description: "Place orders on Polymarket with geo-unrestricted server-side execution"
layout: "page"
---

The Polymarket Order Router enables server-side order placement on Polymarket through Dome's infrastructure. Orders are signed locally by your users' wallets and executed via Dome servers, providing geo-unrestricted access and improved order execution through builder attribution.
