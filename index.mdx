...
<Danger>
  ...
  Read the full announcement [**here**.](http://here.As)
...
[Sign up](https://dashboard.domeapi.io/) for an account and get your API Key from the dashboard. <img src="/images/hero-light.png" alt="Hero Light Pn" />
